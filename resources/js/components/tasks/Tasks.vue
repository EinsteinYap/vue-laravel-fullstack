        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-dark">
                    ...
                    <button class="btn btn-success float-end" @click="createTask" v-if="current_permissions.has('tasks-create')">New Task</button>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <div class="d-flex justify-content-center" v-if="tasksLinks.length > 3">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <li :class="`page-item ${link.active ? 'active' : ''} ${!link.url ? 'disabled' : ''}`" v-for="(link, index) in tasksLinks" :key="index"><a class="page-link" href="#" v-html="link.label" @click.prevent="getResults(link)"></a></li>
                            </ul>
                        </nav>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" v-model="taskData.start_date">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" v-model="taskData.end_date">
